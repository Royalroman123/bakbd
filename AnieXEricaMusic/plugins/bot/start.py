...
@app.on_message(filters.command(["start", "arise"]) & filters.private & ~BANNED_USERS)
@LanguageStart
async def start_pm(client, message: Message, _):
    if len(message.text.split()) == 1:
        loading_1 = await message.reply_text("💫")
        await asyncio.sleep(0.1)
        await loading_1.edit_text("ᴡᴀɪᴛ")
        await asyncio.sleep(0.1)
        await loading_1.edit_text("sᴛᴀʀᴛɪɴɢ.")
        await asyncio.sleep(0.1)
        await loading_1.edit_text("sᴛᴀʀᴛɪɴɢ..")
        await asyncio.sleep(0.1)
        await loading_1.edit_text("sᴛᴀʀᴛᴇᴅ...")
